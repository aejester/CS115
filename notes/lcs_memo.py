...
def test(): 
    print(testLCS("How much wood could a wood chuck chuck if a wood chuck could chuck wood?", "How much tree could a tree chuck chuck if a tree chuck could chuck tree?"))
